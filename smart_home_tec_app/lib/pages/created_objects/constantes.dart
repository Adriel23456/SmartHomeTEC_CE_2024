...
const badChamberNameText =
    "El nombre del aposento no es correcto para este usuario";
...
const wrongDeviceText = "El dispositivo no se puede transferir";
const nonExistentTargetText = "No se encontro el usuario de destino";
const wrongUserText = "Este no es su usuario";
